...
public class LoansRest {
    ...
    @GetMapping("/dept/{id}")
    public ResponseEntity<List<Customers>> getDeptCustomerId(@PathVariable("id") Long id) {
        return new ResponseEntity<List<Customers>>(loansService.getDeptCustomer(id), HttpStatus.OK);
    }
}
