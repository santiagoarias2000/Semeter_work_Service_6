...
class AuthorBookCreate {
    static createBookAuthor(sqlConfirm, sqlCreate, parameter, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield connectionDB_1.default.task((consult) => __awaiter(this, void 0, void 0, function* () {
                ...
                .then((response) => {
                if ((response === null || response === void 0 ? void 0 : response.id_author_book) != 0) {
                    res.status(200).json({ answer: 'Create author book', newCode: response === null || response === void 0 ? void 0 : response.id_author_book });
                }
                else {
...
exports.default = AuthorBookCreate;
