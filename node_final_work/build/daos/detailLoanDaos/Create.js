    ...
    static createBook(sqlConfirm, sqlCreate, parameter, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield connectionDB_1.default.task((consult) => __awaiter(this, void 0, void 0, function* () {
                ...
                .then((response) => {
                if ((response === null || response === void 0 ? void 0 : response.id_detail_loan) != 0) {
                    res.status(200).json({ answer: 'Create detail loan', newCode: response === null || response === void 0 ? void 0 : response.id_detail_loan });
                }
                else {
...
exports.default = DetailLoanCreate;
