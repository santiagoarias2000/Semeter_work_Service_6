...
class DetailLoanUpdate {
    static updateBook(sqlUpdate, paramentros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield connectionDB_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
                ...
                res.status(200).json({ respuesta: 'Update data from Detail loan', });
            })
                .catch((miError) => {
                console.log(miError);
                res.status(400).json({ respuestas: 'Error for DetailLoanUpdate' });
            });
        });
    }
}
exports.default = DetailLoanUpdate;
